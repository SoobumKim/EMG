...
class preprocess_dataset():
    ...
    def load_dataset(self):
        ...
        valid_loader = DataLoader(valid_dataset, batch_size=8, num_workers=4, pin_memory=True, collate_fn=collate_fn)
        test_loader  = DataLoader(test_dataset, batch_size=8, num_workers=4, pin_memory=True, collate_fn=collate_fn)
